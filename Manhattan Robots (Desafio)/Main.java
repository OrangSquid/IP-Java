...
public class Main {
	...
	public static final String DISTANCIA_ENTRE = "DR";
	public static final String MAIOR_MOVIMENTO = "LMV";
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < 5; i++) {
			...
			if(!choice.matches(DISTANCIA_ENTRE + "|" + DISTANCIA_MAXIMA + "|" + MAIOR_MOVIMENTO)) {
			...
			case DISTANCIA_MAXIMA:
				...
				break;
			case DISTANCIA_ENTRE:
				System.out.println(robot1.distanceBetween(robot2));
				break;
			case MAIOR_MOVIMENTO:
				if(robot1.getBiggestMovement() == robot2.getBiggestMovement()) {
					System.out.println("EMPATE");
				}
				else if(robot1.getBiggestMovement() > robot2.getBiggestMovement()) {
					System.out.println("ROBOT 1");
				}
				else if(robot1.getBiggestMovement() < robot2.getBiggestMovement()) {
					System.out.println("ROBOT 2");
