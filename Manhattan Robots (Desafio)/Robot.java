...
public class Robot {
	...
	private int biggest_movement = 0;
	...
	public int getBiggestMovement() {
		return biggest_movement;
	}
	...
	public void move(int distance) {
		...
		if(biggest_movement < distance) {
			biggest_movement = distance;
		}
	}
	...
	public int distanceBetween(Robot other) {
		return Math.abs(cord_x - other.getX()) + Math.abs(cord_y - other.getY());
	}
